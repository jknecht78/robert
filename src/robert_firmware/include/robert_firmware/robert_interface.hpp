#ifndef ROBERT_INTERFACE_HPP
#define ROBERT_INTERFACE_HPP
...
class RobertInterface : public hardware_interface::SystemInterface
{
public:
  RobertInterface();
  virtual ~RobertInterface();
